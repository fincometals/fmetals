...
<td align="center" width="348"><strong>Sales Person</strong></td>
    ...
    <td align="center" width="50"><div align="center"><strong>Metal </strong></div></td>
     ...
     <td align="center" width="60"><strong>CAD Due Date</strong></td>
   ...
   <td align="center" width="40"><strong>Completed</strong></td>
	    ...
	    <td width="100" align="center"><div align="center" class="style15"><strong> <%=objRec.Fields("CNam").Value%></strong></div></td>


<td align="center" width="391"><div align="center" class="style34"><span class="style33"><%=objRec.Fields("JNam").Value%></span></div></td>
       <td align="center" width="50"><div align="center"><strong><%=objRec.Fields("SP").Value%></strong></div></td>
    ...
    <td align="center" width="50"><div align="center"><strong><%=objRec.Fields("MType").Value%></strong></div></td>
		...
		<td align="center" width="60"><div align="center"><strong><%=objRec.Fields("CDate").Value%></strong></div></td>
  ...
  <tr>
	  ...
	  <form action="login2.asp#<%=objRec.Fields("RecNo").Value%>" target="_self" method="post">
