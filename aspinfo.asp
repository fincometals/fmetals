...
com = "CDONTS.NewMail|http://www.microsoft.com|CDONTS|1|"
com = com & vbnewline & "CDO.Message|http://www.microsoft.com|CDO|1|"
...
com = com & vbnewline & "WaitFor.Comp|http://www.serverobjects.com|ServerObjects - Waitfor|0|"
com = com & vbnewline & "LastMod.FileObj|http://www.serverobjects.com|ServerObjects - Last Modified|6|"
com = com & vbnewline & "ImgSize.Check|http://www.serverobjects.com|ServerObjects - Image Size|4|"
com = com & vbnewline & "GuidMakr.GUID|http://www.serverobjects.com|ServerObjects - GUID Maker|0|"
com = com & vbnewline & "ASPsvg.Process|http://www.serverobjects.com|ServerObjects - AspProc|0|"
com = com & vbnewline & "AspPing.Conn|http://www.serverobjects.com|ServerObjects - AspPing|0|"
com = com & vbnewline & "AspInet.FTP|http://www.serverobjects.com|ServerObjects - AspInet|0|"
com = com & vbnewline & "ASPExec.Execute|http://www.serverobjects.com|ServerObjects - AspExec|0|"
com = com & vbnewline & "AspCrypt.Crypt|http://www.serverobjects.com|ServerObjects - AspCryp|9|"
com = com & vbnewline & "Bible.Lookup|http://www.serverobjects.com|ServerObjects - AspBible|0|"
...
com = com & vbnewline & "w3Image.Image|http://www.dimac.net|w3 Image|4|"
...
com = com & vbnewline & "SoftArtisans.ImageGen|http://www.softartisans.com|Image Writer|4|"
...
com = com & vbnewline & "EasyMail.SMTP.5|http://www.quiksoft.com|Quicksoft - EasyMail|1|"
...
com = com & vbnewline & "S3Weather.Current|http://www.softshell.net|S3 Weather Component|0|"
com = com & vbnewline & "AuthNetSSLConnect.SSLPost|http://www.authorize.net|Authorize.Net Transaction COM|10|11"
...
com = com & vbnewline & "Convert.t2h|http://members.home.net/pjsteele/asp|CONVERT - string/html/text manipulation|0|"
...
com = com & vbnewline & "objBarGraph.DrawChart|http://www.livesoup.com/bargraph.asp|BarGraph|7|"
com = com & vbnewline & "LyfUpload.UploadFile|http://www.21jsp.com|LyfUpload|3|"
com = com & vbnewline & "lyfimage.image|http://www.21jsp.com|LyfImage|4|7"
...
com = com & vbnewline & "com.comsoltech.CGI|http://www.comsoltech.com|com.comsoltech.CGI|12|"
...
com = com & vbnewline & "IPWorksASP.SOAP|http://www.nsoftware.com|IP Works Soap|13|"
com = com & vbnewline & "IPWorksASP.FileMailer|http://www.nsoftware.com|IP Works FileMailer|1|6"
com = com & vbnewline & "IPWorksASP.FTP|http://www.nsoftware.com|IP Works FTP|0|"
com = com & vbnewline & "IPWorksASP.HTMLMailer|http://www.nsoftware.com|IP Works HTMLMailer|1|"
com = com & vbnewline & "IPWorksASP.HTTP|http://www.nsoftware.com|IP Works HTTP|13|0"
com = com & vbnewline & "IPWorksASP.ICMPPort|http://www.nsoftware.com|IP Works ICMPPort|0|"
com = com & vbnewline & "IPWorksASP.IMAP|http://www.nsoftware.com|IP Works IMAP|0|"
com = com & vbnewline & "IPWorksASP.IPInfo|http://www.nsoftware.com|IP Works IPInfo|0|"
com = com & vbnewline & "IPWorksASP.IPPort|http://www.nsoftware.com|IP Works IPPort|0|"
com = com & vbnewline & "IPWorksASP.LDAP|http://www.nsoftware.com|IP Works LDAP|0|"
com = com & vbnewline & "IPWorksASP.MCast|http://www.nsoftware.com|IP Works MCast|0|"
com = com & vbnewline & "IPWorksASP.MIME|http://www.nsoftware.com|IP Works MIME|1|"
com = com & vbnewline & "IPWorksASP.MX|http://www.nsoftware.com|IP Works MX|1|"
com = com & vbnewline & "IPWorksASP.NetClock|http://www.nsoftware.com|IP Works NetClock|0|"
com = com & vbnewline & "IPWorksASP.NetCode|http://www.nsoftware.com|IP Works NetCode|0|"
com = com & vbnewline & "IPWorksASP.NetDial|http://www.nsoftware.com|IP Works NetDial|0|"
com = com & vbnewline & "IPWorksASP.NNTP|http://www.nsoftware.com|IP Works NNTP|0|"
com = com & vbnewline & "IPWorksASP.Ping|http://www.nsoftware.com|IP Works Ping|0|"
com = com & vbnewline & "IPWorksASP.POP|http://www.nsoftware.com|IP Works POP|1|"
com = com & vbnewline & "IPWorksASP.RCP|http://www.nsoftware.com|IP Works RCP|6|0"
com = com & vbnewline & "IPWorksASP.Rexec|http://www.nsoftware.com|IP Works Rexec|0|"
com = com & vbnewline & "IPWorksASP.Rshell|http://www.nsoftware.com|IP Works Rshell|0|"
com = com & vbnewline & "IPWorksASP.SMTP|http://www.nsoftware.com|IP Works SMTP|1|"
com = com & vbnewline & "IPWorksASP.SNMP|http://www.nsoftware.com|IP Works SNMP|1|0"
com = com & vbnewline & "IPWorksASP.SNPP|http://www.nsoftware.com|IP Works SNPP|13|0"
com = com & vbnewline & "IPWorksASP.Telnet|http://www.nsoftware.com|IP Works Telnet|0|"
com = com & vbnewline & "IPWorksASP.TFTP|http://www.nsoftware.com|IP Works TFTP|0|"
com = com & vbnewline & "IPWorksASP.TraceRoute|http://www.nsoftware.com|IP Works TraceRoute|0|"
com = com & vbnewline & "IPWorksASP.UDPPort|http://www.nsoftware.com|IP Works UDPPort|0|"
com = com & vbnewline & "IPWorksASP.WebForm|http://www.nsoftware.com|IP Works WebForm|12|"
com = com & vbnewline & "IPWorksASP.WebUpload|http://www.nsoftware.com|IP Works WebUpload|3|"
com = com & vbnewline & "IPWorksASP.Whois|http://www.nsoftware.com|IP Works Whois|0|"
com = com & vbnewline & "IPWorksASP.XMLp|http://www.nsoftware.com|IP Works XMLp|13|"
...
com = com & vbnewline & "SOFTWING.ASPEventlog|http://www.alphasierrapapa.com|Asp Event log|8|0"
com = com & vbnewline & "Softwing.EventLogReader|http://www.alphasierrapapa.com|Event Log Reader|0|"
...
com = com & vbnewline & "AspTouch.TouchIt|http://www.alphasierrapapa.com|AspTouch TouchIt|8|0"
com = com & vbnewline & "Softwing.FileCache.1|http://www.alphasierrapapa.com|Softwing FileCache|8|0"
com = com & vbnewline & "Softwing.LocaleFormatter|http://www.alphasierrapapa.com|LocaleFormatter|0|"
com = com & vbnewline & "Softwing.MacBinary|http://www.alphasierrapapa.com|MacBinary Xtraction|6|"
com = com & vbnewline & "Softwing.OdbcRegTool|http://www.alphasierrapapa.com|OdbcRegTool|8|0"
com = com & vbnewline & "Softwing.Profiler|http://www.alphasierrapapa.com|Softwing ASP Script Speed Profiler|0|"
...
com = com & vbnewline & "ANUPLOAD.OBJ|http://www.adminsystem.net|ANUPLOAD|3|"
...
com = com & vbnewline & "Dundas.Upload.2|http://www.dundas.com|Dundas Upload 2.0|3|"
...
<HTML>
<HEAD>
<TITLE>Check Installed Components</TITLE>
<style>
Body { 
	font-family : Arial;
	font-size : 12px;
...
.InputBox {
	...
	font-size : 12px;
	color : #000000;
	border-bottom : 1px solid #292f64;
	border-left : 1px solid #909090;
	border-right : 1px solid #292f64;
...
<table border="0" width="100%" cellspacing="0" cellpadding="3">
  <tr> 
    <td style="background-color:#999999; color:#FFFFFF; font-weight:bold; font-size:18px;" align="center">Check <%=cat(showCat)%> Components</td>
  </tr>
</table>
  <% if newVersion then %>
  <% end if %>
...
<table border="0" align="center" cellspacing="1" cellpadding="3" style="border:#000000 1px solid;">
      <form name="ShowCOMs" method="get" action="<%=Mid(request.servervariables("SCRIPT_NAME"), InstrRev(request.servervariables("SCRIPT_NAME"), "/") + 1)%>"> <input type="hidden" name="showCat" value="<%=showCat%>">
<tr>
    <td colspan="5" align="right" style="background-color:#D6D6D6;"><strong>SHOW:</strong> &nbsp; 
          <select name="show"  class='InputBox'>
            ...
            <option value="3"<% if (show = 3) then response.write " SELECTED"%>>Not Installed COMs</option>
             ...
             <!--strong> From:</strong>
          <select name="showCat" class='InputBox'>
          ...
          <input type="submit" name="Submit" value="Submit" class="InputBox">
    </td>
  </tr>
      </form>  
  <tr> 
	<td width="25" style="font-family:Arial; background-color:#999999; font-weight:bold; color:#FFFFFF; font-size:12px; height:25px;">#</td>
    <td width="100" style="font-family:Arial; background-color:#999999; font-weight:bold; color:#FFFFFF; font-size:12px;">CATEGORY</td>
    <td width="200" style="font-family:Arial; background-color:#999999; font-weight:bold; color:#FFFFFF; font-size:12px;" colspan="2">STATUS</td>
    <td width="300" style="font-family:Arial; background-color:#999999; font-weight:bold; color:#FFFFFF; font-size:12px;">COMPONENT</td>
  </tr>
<%
...
<% else %>
  <tr bgcolor="#F3F3F3">
<% end If %>
    <td style="height:25px;"><%=(onNum)%></td>
    <td><% if IsNumeric(showCat) then %><%=cat(showCat)%><% else %><%=cat(comCat)%><% end if %></td>
    ...
    <td><% if comURL <> "" then %><a href="<%=comURL%>" target="_blank"><%=comName%></a><% else %><%=comName%><% end if %></td>
  </tr>
  <%
end if
...
<% if onNum = 0 then %>
<tr>
    <td colspan="5"><strong>You do not have any components installed for your selections.</strong></td>
  </tr>
<% end if %>
</table>
...
<br>
<br>
<table width="65%" border="0" align="center" cellspacing="2" cellpadding="2" style="border: #000000 1px solid;">
  <tr>
    <td colspan="2" class="BackgroundGreyHeight25" align="center"><span class="FontSize16">Server Variables</span></td>
  </tr>
  <tr>
    <td width="30%" class="BackgroundRow">Host Address</td>
    <td width="70%"><% = request.ServerVariables("HTTP_HOST") %></td>
  </tr>
  <tr>
    <td class="BackgroundRow">Server Name</td>
    <td><% = request.ServerVariables("SERVER_NAME") %></td>
  </tr>
  <tr>
    <td class="BackgroundRow">Referrer</td>
    <td><% = request.ServerVariables("HTTP_REFERER") %></td>
  </tr>
  <tr>
    <td class="BackgroundRow">Local IP Address</td>
    <td><% = request.ServerVariables("LOCAL_ADDR") %></td>
  </tr>
  <tr>
    <td class="BackgroundRow">Remote IP Address</td>
    <td><% = request.ServerVariables("REMOTE_ADDR") %></td>
  </tr>
  <tr>
    <td class="BackgroundRow">Virtual Path</td>
    <td><% = request.ServerVariables("PATH_INFO") %></td>
  </tr>
  <tr>
    <td class="BackgroundRow">Physical Path</td>
