...
function OutputForm()
%>
    <form name="frmSend" method="POST" enctype="multipart/form-data" accept-charset="utf-8" action="uploadTester4.asp?RecNo=<%=strRecNo%>&Jnam=<%=strJNam%>&Pwd=<%=strPwd%>&EML=<%=strEML%>" onSubmit="return onSubmitForm();">
...
function TestEnvironment()
    ...
    if not fso.FolderExists(uploadsDirVar) then
        TestEnvironment = "<B>Folder " & uploadsDirVar & " does not exist.</B><br>The value of your uploadsDirVar is incorrect. Open uploadTester4.asp in an editor and change the value of uploadsDirVar to the pathname of a directory with write permissions." & Response.write(Server.MapPath("uploadTester4.asp"))
        exit function
    end if
    ...
    If Err.Number<>0 then
        TestEnvironment = "<B>Folder " & uploadsDirVar & " does not have write permissions.</B><br>The value of your uploadsDirVar is incorrect. Open uploadTester4.asp in an editor and change the value of uploadsDirVar to the pathname of a directory with write permissions."
        exit function
    end if
    Err.Clear
    testFile.Close
...
<a href="login2.asp?eml=<%=streml%>">GO BACK</a>
