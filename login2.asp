...
dim strUname, strPwd, strPassChecker, strChooser, strCust, strPwd2, strCan, strE

strE=request.querystring("eml")
...
If strChooser="Board" Or strChooser="GO BACK" Or strChooser="edit" Or strChooser="REFRESH" or strChooser="Cancel " Or strChooser="view" Or strChooser="minimize" Then
...
Dim strDate, strCnam, strJnam, strODate, strFSize, strMType, strSinfo, strComments, strDDate, strCam, strChoo, strCdate, strSP     
...
strCdate = Request.Form("Cdate")
strSP = Request.Form("SP")
...
.style76 {color: #FFFFFF; font-weight: bold; }
.style77 {
	font-family: "Calisto MT";
	font-size: 36px;
}
...
If strPWD="00" Then%>
  ...
  <p class=" style38 style38 style38"><span class="style73"><a href="mailto:<%=ee%>"><%=strCoNam%></a></span> <span class="style73">Job Board</span></p>




<form action="login2.asp" method="post" target="_blank">
<%If strConam="JT Diamonds" Or strConam="Gold and Diamond Specialists" Or strConam="REPAIR BOARD" Then %>
<tr>
...
<td><select name="UName" selected value="">
				 ...
				 <option value="johnthomasjewelers@gmail.com"> JTD </option>
				 <option value="JTD@JTD.com"> Gold and Diamond Specialists </option>
				 <option value="JTD2@JTD.com"> REPAIR JOBS </option>
...
End if%>
  ...
  <div align="center" class="style14 style20 style35 style44"></div>
...
%>
 <p class="style14 style23 style78">Add a Job</p> 
 ...
 <table align="center" width="750" border="1" bgcolor="#666666">
    ...
    <TD align="center" width="25">Sales Person</td>
	<TD align="center" width="25">CAD Due Date</td>
  ...
  <form action="login2.asp" method="post" target="_self" id="form1">
...
<form action=login2.asp?choo=Login target="_self" method="post">
...
<div align="center" class="style14 style20 style35 style44">
  <p class="style37"><div class="style40 style42"><span class="style77"><a name="pending">Pending Jobs</a>
  ...
  <form action=login2.asp#pending method=post target="_self">
  <input type="hidden" name="upwd" value="<%=strPwd%>">
  <input type="hidden" name="uname" value="<%=strUname%>">
...
<table width="980" border="1" align="center" bgcolor="#666666">
    <tr align="center">
               ...
               <td width="86" align="center" class="style44"><div align="center" class="style34 style42"><span class="style51 style62">Job  <a name="<%=objRec8.Fields("RecNo").Value%>" class="style49 style49"><strong><%=objRec8.Fields("RecNo").Value%></strong></a></span></div></td>
              
			  <td width="146" align="center" class="style44">Sales Person: <strong><%=objRec8.Fields("SP").Value%></strong></td>
    
 <td width="146" align="center" class="style44">Order Date: <strong><%=objRec8.Fields("ODate").Value%></strong></td>
 <td width="146" align="center" class="style44">CAD Due Date: <strong><%=objRec8.Fields("CDate").Value%></strong></td>
...
%>
<form id="userform" action=login2.asp#<%=objRec8.Fields("RecNo").Value%> method="post" target="_self">
  <span class="style44">
<input type="hidden" name="Uname" value="<%=strUname%>">
<input type="hidden" name="Upwd" value="<%=strPwd%>">
...
<form action=login2.asp#<%=objRec8.Fields("JNam").Value%> method=post target="_self">
  <input type="hidden" name="upwd" value="<%=strPwd%>">
  <input type="hidden" name="uname" value="<%=strUname%>">
...
<tr><td colspan="8">
<form action=login2.asp#<%=objRec8.Fields("RecNo").Value%> method="post" target="_self"><A Href="uploadtester4.asp?recno=<%=objRec8.Fields("RecNo").Value%>&jnam=<%=objRec8.Fields("JNam").Value%>&pwd=<%=strPwd%>&eml=<%=strUname%>" target="_self" class="style42 style35 style60">Upload Photos</a> 
<input type="hidden" name="Uname" value="<%=strUname%>">
<input type="hidden" name="Upwd" value="<%=strPwd%>">
...
%>
<div align="center" class="style14 style20 style35"><p class="style37"><a name="open" class="style61"><span class="style77">Open Jobs</span>
  <form action=login2.asp#open method=post target="_self">
  <input type="hidden" name="upwd" value="<%=strPwd%>">
  <input type="hidden" name="uname" value="<%=strUname%>">
...
<table width="980" border="1" align="center" bgcolor="#666666">
    <tr align="center">
      ...
      <form action="login2.asp#<%=objRec2.Fields("JNam").Value%>" method="post" target="_self">
	  <input type="hidden" name="upwd" value="<%=strPwd%>">
  <input type="hidden" name="uname" value="<%=strUname%>">
...
<%end if%>	  </td>
  ...
  <td align="center" width="89">Sales Person <strong><%=objRec2.Fields("SP").Value%></strong></td>   
 <td align="center" width="89">Order Date: <strong><%=objRec2.Fields("ODate").Value%></strong></td>
 <td align="center" width="89">Cad Due Date: <strong><%=objRec2.Fields("CDate").Value%></strong></td>
...
<td></td>
 ...
 <tr bgcolor="#CCCCCC">
 <td></td>
 <td align="center" width="40"><strong>Instructions:</strong><br><A Href="uploadtester4.asp?recno=<%=objRec2.Fields("RecNo").Value%>&jnam=<%=objRec2.Fields("JNam").Value%>&pwd=<%=strPwd%>&eml=<%=strUname%>" target="_self" class="style42 style60">Upload Photos</a></td>   
...
Add instructions here...</textarea>
 </td><TD><form action="login2.asp#<%=objRec2.Fields("JNam").Value%>" target="_self" method="post" id="userform2">
 <input type="hidden" name="UName" value="<%=strUname%>">
 <input type="hidden" name="UPwd" value="<%=strPwd%>">
...
Else
%>
<div align="center" class="style14 style21 style38">Completed Jobs</div>
...
%>   
      ...
      <form action="custdetails2.asp" action="post" target="_self"> 
...
<input type="submit" value="view">	  </td></form>
...
%><script language="javascript">
<!--
alert("Please send email...");
location.href="index.html";
//-->
</script> 
</p>
<form action="dupchk2.asp" method="post" accept-charset="utf-8" >
  <p>
  ...
  <div class="form-all">
    <ul class="form-section">
      <li class="form-line form-line-column" id="id_1">
        <label class="form-label-top" id="label_1" for="input_1"> Full Name </label>
        <div id="cid_1" class="form-input-wide"><span class="form-sub-label-container"><input class="form-textbox" type="text" size="10" name="fname" id="first_1" />
      ...
      <li class="form-line form-line-column" id="id_5">
        <label class="form-label-top" id="label_5" for="input_5"> Password </label>
      ...
      <li class="form-line form-line-column" id="id_6">
        <label class="form-label-top" id="label_6" for="input_6"> Password (confirm) </label>
      ...
      <li class="form-line form-line-column" id="id_9">
        <label class="form-label-top" id="label_9" for="input_9"> Contact Number </label>
      ...
      <li class="form-line form-line-column" id="id_3">
        <label class="form-label-top" id="label_3" for="input_3"> E-mail </label>
      ...
      <li class="form-line form-line-column" id="id_7">
        <label class="form-label-top" id="label_7" for="input_7"> Confirm E-mail </label>
