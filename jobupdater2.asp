...
If strCas="" Or strCas="ALL" Then 

strSQL = "SELECT * FROM MEMDB Where Status<>'OPEN' ORDER BY Cnam ASC"

Else

strSQL="SELECT * FROM MEMDB WHERE CNAM='"&strCAS&"' AND Status<>'OPEN' ORDER BY Cnam, Status, ODATE ASC"
...
<p class="style14 style16"><span class="style20">Closed Jobs</span><a href="jobupdater.asp?pass=<%=strpass2%>" target="_self" class="style19 style21">(OPEN)  </a><a href="jobupdater3.asp?pass=<%=strpass2%>" target="_self" class="style19 style15 style20">  (ALL JOBS)</a></p>
<%
Else  
...
%>
  ...
  <p class="style14 style16"><span class="style20">Closed  JOBS</span><a href="jobupdater.asp?pass=<%=strpass2%>" target="_self" class="style19 style21">(OPEN)  </a><a href="jobupdater3.asp?pass=<%=strpass2%>" target="_self" class="style20 style19">  (ALL JOBS)</a></p>
   <%
...
<table>
<form action="jobupdater2.asp?pass=<%=strpass%>" method="post" target="_self">
...
objRec.AbsolutePage = PageNo  %>
  ...
  <form action="jobupdater2.asp" method="POST" class="style8">
